"""
Pullback Bear Continuation Strategy.

Logic: Pullback to VWAP in a downtrend, then continuation short.
...
class PullbackBearContinuationStrategy(BaseStrategy):
    """Pullback to VWAP continuation short — requires downtrend context."""

    # ── Identity ───────────────────────────────────────────────────────────────

    @property
    def name(self) -> str:
        return "pullback_bear_continuation"
    ...
    def generate_candidate(
        ...
        try:
            ...
            # 3. Require downtrend
            if structure is None or structure.trend != TrendDirection.DOWNTREND:
                return None
            ...
            # 6. Bearish bar: close < open — selling at VWAP
